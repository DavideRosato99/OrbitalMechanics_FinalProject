function [DV_MIN, Dv_min_TOF_1, Dv_min_TOF_2, r1_arc, r2_arc, r3_arc, v_venus, t_venus, vInfMin, vInfPlus, dv_ga, Data, hp] = GA_FlybyMod2( ga_it, t_start_j_1, t_end_j_2 )
% GA_FlybyMod2 starting from a window of dates this function minimize an objective function (dv_optMod2) with ga
%
% PROTOTYPE:
%	[DV_MIN, Dv_min_TOF_1, Dv_min_TOF_2, r1_arc, r2_arc, r3_arc, v_venus, t_venus, vInfMin, vInfPlus, dv_ga, Data, hp] = GA_FlybyMod2( ga_it, t_start_j_1, t_end_j_2 )
%
% INPUT:
