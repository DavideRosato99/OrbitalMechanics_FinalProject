function [DV_MIN, Dv_min_TOF_1, Dv_min_TOF_2, r1_arc, r2_arc, r3_arc, v_venus, t_venus, vInfMin, vInfPlus, dv_ga, Data, hp] = GA_ref_con( ga_it_ref,ref_days,options_GAref,Data_min_con)
% GA function used for the refinement of the results obtained from the
% Global GA analysis of the constrained values 
...
t_dep_opt = Data_min_con(1);
t_Flyby_opt = Data_min_con(2);
t_arr_opt = Data_min_con(3);
