...
% PROTOTYPE:
%   [VV_minus, VV_plus] = flybyPlotHelio(vv_inf_minus, VV_p, Delta, rr_s2p , mu_s, mu_p, inc_asymptote_angularPos, handle)
% 
% DESCRIPTION:
%   Returns the plot of the heliocentric trajectory before and after the
%   flyby and the velocity vectors before and after the flyby, in 
%   heliocentric frame 
% 
% INPUT:
%	vv_inf_minus    asymptotic velocity vector before the flyby
%   VV_p     planet velocity vector in heliocentric frame
%   Delta     impact paramenter
%   rr_s2p    position vector of the planet wrt star-centered frame
%   mu_s     star constant
%   mu_p     planetary constant (planet of the flyby)
%	inc_asymptote_angularPos    angular position of the incoming asymptote
%	{leading, trailing, over, under, angle[rad]}
%   handle     figure handle
% 
% OUTPUT:
%   Plot
%   VV_minus     velocity vector before the flyby in heliocentric frame
%   VV_plus     velocity vector after the flyby in heliocentric frame
% 
% CALLED FUNCTIONS:
%   ode_2body.m
%   plotPlanet.m
%   rotVecAroundVecByAngle.m
