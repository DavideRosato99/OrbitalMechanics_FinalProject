...
% gridSearch - the function performs a grid search optimization to obtain 
% the optimal time windows for departure, fly by and arrival. At each
% generation the number of discretization steps is supposed to be constant
%
% INPUTS:
