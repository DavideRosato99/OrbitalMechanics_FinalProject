...
%
% INPUT:
%  namePlanet     -    string with the name of the planet (not not case
%                           sensitive)
%  position       -    centre of the planet to draw
%  handle         -    Figure or axis handle
%
% OUTPUT:
...
switch namePlanet
        case 'Sun'
            [radPlanet] = astroConstants(3);
        case 'Mercury'
            [radPlanet] = astroConstants(21);
        case 'Venus'
            [radPlanet] = astroConstants(22);
        case 'Earth'
            [radPlanet] = astroConstants(23);
        case 'Mars'
            [radPlanet] = astroConstants(24);
        case 'Jupiter'
            [radPlanet] = astroConstants(25);
        case 'Saturn'
            [radPlanet] = astroConstants(26);
        case 'Uranus'
            [radPlanet] = astroConstants(27);
        case 'Neptune'
            [radPlanet] = astroConstants(28);
%       case 'Asteroid'
%           [radPlanet] = astroConstants(); 
%       case 'Comet'
%           [radPlanet] = astroConstants();
        case 'Moon' 
            [radPlanet] = astroConstants(30);
end  
